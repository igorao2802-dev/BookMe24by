 ...
 *
 * ПОЧЕМУ debounce?
  * ПОЧЕМУ: в.В. из ПР-08: "Когда пользователь печатает 'стрижка' в поиске,
...
import { processSearchInput } from '../../utils/searchInputHelpers';
    ...
    <div className={`search-bar ${className}`}>
      <div className="search-bar__wrapper">
        ...
        <input
          ...
          type="text"
          value={value}
          onChange={(e) => onChange(processSearchInput(e.target.value).value)}
          placeholder={placeholder}
          className="search-bar__input"
          aria-label="Поиск"
          maxLength={VALIDATION_LIMITS.SEARCH_QUERY.maxLength}
        />
