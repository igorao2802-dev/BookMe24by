 ...
 * ПОЧЕМУ презентационный компонент?
  * ПОЧЕМУ: в.В. из лекции React-1-1: "Хороший компонент делает одно дело."
 ...
 * 
  * ПОЧЕМУ: динамический рендеринг названия и описания в зависимости от языка
  * ПОЧЕМУ: полная локализация, включая категории
 */
...
export default function ServiceCard({
  ...
  // ПОЧЕМУ: динамический выбор поля в зависимости от языка
