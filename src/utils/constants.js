...
export const STORAGE_KEYS = {
  ...
  CURRENT_SPECIALIST_ID: "bookme24_current_specialist_id",
...
// === ОГРАНИЧЕНИЯ ЦЕН И ПОЛЕЙ (единый источник — validationLimits.js) ===
export {
  FIELD_LIMITS,
  PRICE_LIMITS,
  VALIDATION_LIMITS,
} from "../constants/validationLimits.js";
 ...
 * ПОЧЕМУ переключатель ролей включён по умолчанию?
 * В курсовом SPA ещё нет реальной авторизации — без него нельзя проверить
 * админку и кабинет специалиста на мобильных и на деплое bookme24.by.
 * Отключение: REACT_APP_SHOW_ROLE_SWITCHER=false в .env (когда появится auth).
 */
export const APP_CONFIG = {
  SHOW_DEMO_ROLE_SWITCHER:
    process.env.REACT_APP_SHOW_ROLE_SWITCHER !== 'false',
};
